# I decided to write a code that generates data filtering object from a list
...
def make_filter(**kwargs):
    ...
    for key, value in kwargs.items():
        def keyword_filter_func(data, val=value, k=key):
            return data[k] == val
...
if __name__ == "__main__":
    a = make_filter(name='polly', type='bird').apply(sample_data)
    print(a)
